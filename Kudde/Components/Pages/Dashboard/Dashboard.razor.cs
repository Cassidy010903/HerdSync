using BLL.Services;
using Kudde.Components.Shared.Components;
using Kudde.Components.Shared.Theme;
using Kudde.Shared.DTO.Animal;
using Kudde.Shared.DTO.Calendar;
using Microsoft.AspNetCore.Components;
using Microsoft.AspNetCore.Components.Web;

namespace Kudde.Components.Pages.Dashboard
{
    public partial class Dashboard
    {
        ...
        private string GetObservationColor(string? flag) => flag?.ToLower() switch
        {
            "high" => "#c0392b",
            "medium" => "#e67e22",
            "low" => KuddeColors.Primary,
            _ => KuddeColors.Primary
        };
